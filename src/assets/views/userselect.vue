      ...
      <nav class="bg-primary p-2">
        <div class="container">
          <div class="flex justify-start ">
            <img src="https://www.climbs.coop/wp-content/uploads/2021/10/climbs-logo.jpg" alt="Sample Image" class="w-10 h-10 ">
          </div>
        </div>
      </nav>
          ...
          <div class="mb-16 lg:mt-32 xl:mt-20 xl:mr-12 px-10 card-animate">
            <div class="bg-white rounded-lg p-6 h-full shadow-2xl">
              ...
              <form class="mx-auto w-full">
                <label for="countries" class="block mb-2 text-sm font-bold text-primary text-start">Select your name</label>
                <select id="countries" class="text-sm focus:ring-blue-500 block w-full p-2.5 rounded-lg border focus:outline-none border-blue-200 bg-gray-100 dark:placeholder-gray-400  focus:border-blue-500">
                  <option selected>Name</option>
                  <option value="1">John Doe</option>
                  <option value="2">Alice Doe</option>
                </select>
              </form>
              <div class="mt-4 flex justify-end">
                <button type="button" class="text-white bg-primary hover:bg-accent w-80 md:w-auto md:mr-0 flex justify-center items-center">
                  Submit
